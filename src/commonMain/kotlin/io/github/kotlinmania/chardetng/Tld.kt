...
private val TWO_LETTER_VALUES: Array<Tld> =
    arrayOf(
        Tld.Generic, // ac
        Tld.Arabic, // ae
        Tld.Arabic, // af
...
private val TWO_LETTER_KEYS: Array<ByteArray> =
    arrayOf(
        ascii("ac"), // Generic
        ascii("ae"), // Arabic
        ascii("af"), // Arabic
...
private val PUNYCODE_KEYS: Array<ByteArray> =
    arrayOf(
...
private val PUNYCODE_VALUES: Array<Tld> =
    arrayOf(
        Tld.Korean, // 3e0b707e
