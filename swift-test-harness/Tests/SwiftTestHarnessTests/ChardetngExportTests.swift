...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `Chardetng.swiftmodule/`
...
//      `import Chardetng` above would fail at compile time.
//
//   2. The static archive `libChardetng.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "Chardetng" }` and
//      `flattenPackage = "io.github.kotlinmania.chardetng"` configuration in
...
//      via the `ChardetngLibrary` product.
//
...
final class ChardetngExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "Chardetng swift module imported cleanly")
    }
}
