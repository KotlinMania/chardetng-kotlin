...
This file is the quick-reference operating contract for chardetng-kotlin. The longer
...
chardetng-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`chardetng`](https://crates.io/crates/chardetng). Upstream Rust is the behavioral oracle while the
